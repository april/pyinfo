...
def print_tc_table(heading, table_list):
	print "<table><th colspan=\"2\" class=\"h\">%s</th>" % heading;
	while table_list:
...
# Print usual top-of-HTML stuff
print """
<html>
  <head>
    <title>pyinfo()</title>
    <style type="text/css">
      table { border-collapse: collapse; margin-left: 10%; width: 80%; }
      td, th { border: solid 1px black; }
      th { font-size: large; }
      .copyright { background-color: #ccccff; font-weight: none; padding: .5em; }
      .e { background-color: #ccccff; font-weight: bold; padding-left: .25em; padding-right: .25em; white-space: nowrap; width: 20%; }
      .h { background-color: #9999cc; font-weight: bold; }
      .v { background-color: #cccccc; padding-left: .25em; }
      .version { font-size: 150%; padding: .5em; text-align: center; }
    </style>
  </head>
  <body>""";
...
# Print Python license
print """
<table>
  <th class="h">Python Copyright</th>
  <tr class="copyright"><td class="copyright">%s</td></tr>
</table><br />
